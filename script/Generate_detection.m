...
List = load('/disk2/for_hico_det/Data/hico_20160224_det/anno.mat', 'list_test');
List = List.list_test;
for i = 1 : 9658
    list(i) = str2double(List{i}(end-9 : end-4));
end

mkdir 'output/ho_1_s/hico_det_test2015/sd0'
parpool(4)
parfor obj_idx = 1 : 80
    disp(obj_idx)
    Detection = load(['/home/liyonglu/projects/iCAN/Results/HICO/1800000_sd0/detections_' sprintf('%02d',obj_idx) '.mat']);
...
%     clear all_boxes
    save_mat(obj_idx, 'output/1800000_sd0', all_boxes)
end
