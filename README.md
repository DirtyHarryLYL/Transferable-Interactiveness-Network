...
**Please note that we have reimplemented TIN (e.g. replacing the vanilla HOI classifier with iCAN and using cosine_decay lr), thus the result here is different and slightly better than the one in [[Arxiv]](https://arxiv.org/abs/1811.08264).**
