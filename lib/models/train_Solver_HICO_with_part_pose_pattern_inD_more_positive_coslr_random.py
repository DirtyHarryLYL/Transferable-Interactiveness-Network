...
from ult.ult import Get_Next_Instance_HO_Neg_HICO_pose_pattern_version2_with_part
...
class SolverWrapper(object):
    ...
    def __init__(self, sess, network, Trainval_GT, Trainval_N, output_dir, tbdir, Pos_augment, Neg_select, Restore_flag,
                 pretrained_model, interval_divide):
    ...
    def train_model(self, sess, max_iters):
        ...
        while iter < max_iters + 1:
            ...
            blobs = Get_Next_Instance_HO_Neg_HICO_pose_pattern_version2_with_part(self.Trainval_GT, self.Trainval_N,
                                                                                  image_id, self.Pos_augment,
...
def train_net(network, Trainval_GT, Trainval_N, output_dir, tb_dir, Pos_augment, Neg_select, Restore_flag,
    ...
    with tf.Session(config=tfconfig) as sess:
        sw = SolverWrapper(sess, network, Trainval_GT, Trainval_N, output_dir, tb_dir, Pos_augment, Neg_select,
                           Restore_flag, pretrained_model, interval_divide)
